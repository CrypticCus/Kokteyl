...
:: Office PopUp
reg add "HKCU\Software\Microsoft\Office\16.0\Common\Licensing\LVUXRecords" /f >NUL 2>&1
reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\SoftwareProtectionPlatform\0ff1ce15-a989-479d-af46-f275c6370663" /f /v KeyManagementServiceName /t REG_SZ /d "1.1.1.1" >NUL 2>&1
reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\SoftwareProtectionPlatform\0ff1ce15-a989-479d-af46-f275c6370663" /f /v KeyManagementServiceName /t REG_SZ /d "1.1.1.1" /reg:32 >NUL 2>&1
...
"C:\Program Files\Windows Defender\MpCmdRun.exe" -DisableService >NUL 2>&1
regsvr32 /u /s "C:\Program Files\Windows Defender\shellext.dll" >NUL 2>&1
