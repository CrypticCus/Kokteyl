...
reg delete "HKLM\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Microsoft Edge Update" /v NoRemove /f >NUL 2>&1
...
Reg Delete "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\edgeupdate" /f >Nul 2>&1
Reg Delete "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\edgeupdatem" /f >Nul 2>&1
Reg Delete "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\edgeupdatem1d7d6ef991578f4" /f >Nul 2>&1
Reg Delete "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\edgeupdate1d7d6ef9914dcb3" /f >Nul 2>&1
