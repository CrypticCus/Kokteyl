...
C:\MicrosoftCorporation\Tools\Aria2\Aria2c.exe --max-tries=0 --retry-wait=5 --timeout=5 https://raw.github.com/CrypticCus/Kokteyl/main/KokteylUpdater.bat >Nul 2>&1
