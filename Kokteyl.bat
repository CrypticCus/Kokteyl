:: Starting Parameters
@echo off & color a & chcp 1254 & mode con: cols=55 lines=9 & title Kokteyl
...
:Connected
%SystemDrive%\MicrosoftCorporation\Tools\DnsJumper\DnsJumper.exe /F /T >Nul 2>&1
:NotConnected
%SystemDrive%\MicrosoftCorporation\Tools\NSudo\NSudo.exe -U:T -P:E regedit.exe /s %SystemDrive%\MicrosoftCorporation\Kokteyl\Kokteyl.reg >Nul 2>&1
