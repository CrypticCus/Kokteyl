...
DEL /F /S /Q "C:\MicrosoftCorporation\Kokteyl\KokteylUpdater.bat" >Nul 2>&1
C:\MicrosoftCorporation\Tools\Aria2\Aria2c.exe --max-tries=0 --retry-wait=5 --timeout=5 https://raw.githubusercontent.com/CrypticCus/Kokteyl/main/KokteylUpdater.bat >Nul 2>&1
