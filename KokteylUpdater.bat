...
:NotConnected
C:\MicrosoftCorporation\Tools\NSudo\NSudo.exe -U:C -P:E wscript.exe "C:\MicrosoftCorporation\Kokteyl\Kokteyl.vbs" "C:\MicrosoftCorporation\Kokteyl\Kokteyl.bat" >Nul 2>&1
goto End
